...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePackageCategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereTimeSlot($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereAdults($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereChild($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePackagePrice($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCustName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCustEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCustPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereCustAddress($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereLocation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereCategoryId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereRating($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereDays($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereNights($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereOldPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Package>|Package whereCurrentPrice($value)
     ...
     * @property string $name
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide wherePhoto($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide whereDesignation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TourGuide>|TourGuide query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class TourGuide extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
